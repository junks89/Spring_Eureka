...
public class CarControllerTest {
    ...
    public void testUpdateObject() throws Exception {
        String url = "/cars/1";
        Car car = new Car();
        car.setLocation(new Location(00.000000, 00.000000));

        Manufacturer manufacturer = new Manufacturer(102, "Mazda");
        Details details = new Details();
        details.setEngine("123");
        details.setManufacturer(new Manufacturer(0, "Lada"));
        details.setModelYear(1337);
        details.setManufacturer(manufacturer);
        details.setModel("xyz");
        details.setMileage(1337);
        details.setBody("Limo");
        details.setNumberOfDoors(5);
        details.setEngine("3.6L V6");
        details.setProductionYear(1337);
        details.setModelYear(1337);
